...
Standalone service for analyzing Java source code and binaries
"""
...
from analyzers.java_analyzer import JavaSourceAnalyzer
...
class JavaAnalyzerService:
    """Standalone Java analyzer service"""
    ...
    async def analyze_request(self, request_file: str):
        ...
        try:
            ...
            # Perform analysis
            logger.info(f"Starting Java analysis for {request.location}")
            ...
            logger.info(f"Completed Java analysis, found {len(result.components)} components")
    ...
    async def run(self):
        """Main service loop"""
        logger.info("Java Analyzer Service starting...")
        ...
        while True:
            try:
                ...
                request_files = list(requests_dir.glob("java_*.json"))
